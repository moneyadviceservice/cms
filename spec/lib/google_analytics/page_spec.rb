    ...
    describe 'popular_articles' do
      ...
      let(:google_results){
        [
          ...
          OpenStruct.new(pagePath: "/en/articles/{\"title\":\"Win Money\",\"desc\":\"Online casinoPlay now\"}&cost=0", pageviews: '80'),
          ...
          OpenStruct.new(pagePath: 'http://google.com/http://moneyadviceservice.org.uk/en/articles/ignore-embedded-english-article', pageviews: '40')
        ]
      }
      ...
      it { expect(@results).to_not contain_article_label("{\"title\":\"Win Money\",\"desc\":\"Online casinoPlay now\"}&cost=0")}  # from real analytics
