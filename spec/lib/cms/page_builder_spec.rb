RSpec.describe Cms::PageBuilder do
  ...
  let!(:offline_page_layout) { create(:layout, identifier: 'offline_page', site: english_site) }
  ...
  describe '.add_offline_page!' do
    before { Cms::PageBuilder.add_offline_page! }
    ...
    context 'English site' do
      ...
      it 'adds a page using the "offline page" layout' do
        expect(page.layout).to eq(offline_page_layout)
      end
      ...
      it 'sets the slug to be "offline_page"' do
        expect(page.slug).to eq('offline_page')
      end
      ...
      it 'publishes the offline_page' do
        expect(page).to be_published
      end
    end
    ...
    context 'Welsh site' do
      ...
      it 'adds a page using the "offline page" layout' do
        expect(page.layout.identifier).to eq('offline_page')
      end
      ...
      it 'sets the slug to be "offline page"' do
        expect(page.slug).to eq('offline_page')
      end
