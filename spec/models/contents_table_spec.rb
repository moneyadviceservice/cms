describe ContentsTable do
  subject do
    described_class.new('<div class="contents-table"></div><h2 id="this-is-a-heading">This is a heading</h2><h2 id="this-is-another-heading">This is another heading</h2>')
  end
