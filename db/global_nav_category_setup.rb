...
birth = Comfy::Cms::Category.create!(
  site_id: 1,
...
death = Comfy::Cms::Category.create!(
  site_id: 1,
  legacy_parent_id: dbf.id,
  parent_id: nil,
  label: 'deaths',
...
family = Comfy::Cms::Category.create!(
  site_id: 1,
  legacy_parent_id: dbf.id,
  parent_id: nil,
  label: 'family',
...
care = Comfy::Cms::Category.create!(
  site_id: 1,
...
disability = Comfy::Cms::Category.create!(
  site_id: 1,
  legacy_parent_id: cad.id,
  parent_id: nil,
  label: 'disability',
...
homes = Comfy::Cms::Category.create!(
  site_id: 1,
...
mortgages = Comfy::Cms::Category.create!(
  site_id: 1,
  legacy_parent_id: ham.id,
  parent_id: nil,
  label: 'mortgages',
...
travel = Comfy::Cms::Category.create!(
  site_id: 1,
...
cars = Comfy::Cms::Category.create!(
  site_id: 1,
  legacy_parent_id: cnt.id,
  parent_id: nil,
  label: 'cars',
