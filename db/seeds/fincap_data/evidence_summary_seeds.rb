...
insight_layout = english_site.layouts.find_or_create_by(layouts[:insight])
evaluation_layout = english_site.layouts.find_or_create_by(layouts[:evaluation])
review_layout = english_site.layouts.find_or_create_by(layouts[:review])
