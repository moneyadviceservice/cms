...
module MainMenuHelper
  ...
  MAIN_MENU_OPTION_CSS_CLASS        = 'nav-primary__text'  # Options of the main menu will be rendered with this css class
  MAIN_MENU_OPTION_CSS_ACTIVE_CLASS = 'is-active'          # The currently active option of the main menu will also have this css class
  ...
  def render_main_menu_option(option:)
    ...
    active_link_to(option[:display_name], option[:path], class_active: css_classes_when_active, class_inactive: css_classes_when_no_active)
  end
