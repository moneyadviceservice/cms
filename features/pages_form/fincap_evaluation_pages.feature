Feature: Building Evaluation Pages
  As an Editor
  In order to the build an Evaluation Page
  I want to be able to fill out all the text fields on the form

  Background:
    Given I have an evaluation page layout
    And I am logged in

  Scenario: Creating an evaluation page
    Given I am on the homepage
    And I click on "Create new page"
    And I select "Evaluation" on the creation page
    ...
    And I check
      ...
      | data_types            | financial_wellbeing  |
    ...
    And I should see the checkbox fields with the value
      ...
      | financial_wellbeing          | checked   |
      | financial_capability_mindset | unchecked |
