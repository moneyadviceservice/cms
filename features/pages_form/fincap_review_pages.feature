Feature: Building Review Pages
  ...
  Background:
    Given I have a review page layout
    And I am logged in

  Scenario: Creating an review page
    Given I am on the homepage
    And I click on "Create new page"
    And I select "Review" on the creation page
    ...
    And I should see the checkbox fields with the value
      ...
      | literature_review        | checked   |
      | systematic_review        | unchecked |
